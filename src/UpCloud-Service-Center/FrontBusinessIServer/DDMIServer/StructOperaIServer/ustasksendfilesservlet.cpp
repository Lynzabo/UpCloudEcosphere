#include "ustasksendfilesservlet.h"
...
UpdateStructTaskSendFilesServlet::UpdateStructTaskSendFilesServlet()
{

}

void UpdateStructTaskSendFilesServlet::doExec(DRequestContext *request, DResponseContext *response)
{
    ...
    //处理业务
    try{
        CSStructDao::updateRTaskAndFile(taskUuid,nodes,state);
    }
