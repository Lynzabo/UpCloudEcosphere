#include "ucgroupassocrunnable.h"
...
UpdateClientGroupAssocRunnable::UpdateClientGroupAssocRunnable(QObject *object):m_object(object)
{

}

void UpdateClientGroupAssocRunnable::setGroupAssocInfo(const QVariantMap &params)
{
    m_params = params;
}

void UpdateClientGroupAssocRunnable::run()
{
    quint8 rState;
    ...
    //准备数据
    sender->setExecType(Control_Module::Group_updateGroupNode);
