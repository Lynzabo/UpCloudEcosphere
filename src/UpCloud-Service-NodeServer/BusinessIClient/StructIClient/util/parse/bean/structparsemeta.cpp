                                  ...
                                  const bool &async, const quint32 &asyncNum)
{
    ...
    structParseMeta->houseKeepingSleepTime = houseKeepingSleepTime;
    structParseMeta->waitIntervalTime = waitIntervalTime;
...
StructParseMeta::Builder *StructParseMeta::Builder::setHouseKeepingSleepTime(const int houseKeepingSleepTime)
{
    structParseMeta->houseKeepingSleepTime = houseKeepingSleepTime;
    return this;
}

StructParseMeta::Builder *StructParseMeta::Builder::setWaitIntervalTime(const int waitIntervalTime)
{
    structParseMeta->waitIntervalTime = waitIntervalTime;
    return this;
}
...
int StructParseMeta::getHouseKeepingSleepTime() const
{
    return houseKeepingSleepTime;
}
int StructParseMeta::getWaitIntervalTime() const
{
