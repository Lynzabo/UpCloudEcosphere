...
DelStructTaskRunnable::DelStructTaskRunnable(QObject * object):m_object(object)
{
    m_cbMsg.clear();
    m_cbMsgId = 0;
...
void DelStructTaskRunnable::run()
{
    quint8 rState;
    ...
    //准备数据
    sender->setExecType(Control_Module::Struct_delTask);
...
void DelStructTaskRunnable::setTaskInfo(const QtJson::JsonArray &json)
{
    m_uuids = json;
}
