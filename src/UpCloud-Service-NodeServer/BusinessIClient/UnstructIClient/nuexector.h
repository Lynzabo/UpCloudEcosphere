#ifndef NODERUNSTRUCTEXECTOR_H
#define NODERUNSTRUCTEXECTOR_H
#include "base.h"
#include "db.h"
#include "action.h"
#include "timer.h"
...
class UNSTRUCTICLIENTSHARED_EXPORT NoderUnstructExector : public AbstractExector
{
    Q_OBJECT
public:
    NoderUnstructExector();
    ~NoderUnstructExector();
protected:
    /**
