...
QString CsRStructSendFiles::getHardAbst() const
{
    return hardAbst;
}

void CsRStructSendFiles::setHardAbst(const QString &value)
{
    hardAbst = value;
}

quint8 CsRStructSendFiles::getFileSrc() const
{
    return fileSrc;
}

void CsRStructSendFiles::setFileSrc(const quint8 &value)
{
    fileSrc = value;
}
