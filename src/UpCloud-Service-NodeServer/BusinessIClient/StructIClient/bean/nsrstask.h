#ifndef NSRSTRUCTTASK_H
#define NSRSTRUCTTASK_H
#include <QtCore>

/**
 * @brief The NsRStructTask class   结构化任务处理表
 * 任务状态代表任务状态，0代表废弃状态，1代表任务可用，2代表正在下载，3代表下载出错，
 * 4代表下载成功，5代表正在解析，6代表解析出错，7代表解析成功
 */
class NsRStructTask
{
private:
