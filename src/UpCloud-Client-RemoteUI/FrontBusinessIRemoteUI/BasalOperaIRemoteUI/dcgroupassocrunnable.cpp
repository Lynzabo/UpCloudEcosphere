#include "dcgroupassocrunnable.h"
...
DelClientGroupAssocRunnable::DelClientGroupAssocRunnable(QObject *object):m_object(object)
{
    m_cbMsg.clear();
    m_cbMsgId = 0;
...
void DelClientGroupAssocRunnable::setDelCondition(const QVariantMap &params)
{
    m_params = params;
}

void DelClientGroupAssocRunnable::run()
{
    quint8 rState;
    ...
    //准备数据
    sender->setExecType(Control_Module::Group_delGroupNode);
