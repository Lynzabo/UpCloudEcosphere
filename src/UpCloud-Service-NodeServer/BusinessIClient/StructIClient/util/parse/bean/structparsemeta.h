...
public:
    ...
    public:
        ...
        Builder(const QString &dbType,
                ...
                const int houseKeepingSleepTime,
                const int waitIntervalTime,
                const bool &async,
    ...
    public:
        ...
        Builder*  setHouseKeepingSleepTime(const int houseKeepingSleepTime);
        Builder*  setWaitIntervalTime(const int waitIntervalTime);
