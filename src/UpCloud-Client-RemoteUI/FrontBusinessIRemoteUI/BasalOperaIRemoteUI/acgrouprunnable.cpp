...
AddCsClientGroupRunnable::AddCsClientGroupRunnable(QObject *object):m_object(object)
{
    m_cbMsg.clear();
    m_cbMsgId = 0;
...
void AddCsClientGroupRunnable::setGroupInfo(const QVariantMap &params)
{
    m_params = params;
}

void AddCsClientGroupRunnable::run()
{
    ...
    //准备数据
    sender->setExecType(Control_Module::Group_addClientGroup);
