...
DelDictRunnable::DelDictRunnable( QObject *object):m_object(object)
{
    m_cbMsgId = 0;
    m_cbMsg.clear();
...
void DelDictRunnable::setDictList(const QStringList &uuids)
{
    m_uuids = uuids;
}
...
void DelDictRunnable::run()
{
   ...
   //准备数据
   sender->setExecType(Control_Module::Dict_del);
