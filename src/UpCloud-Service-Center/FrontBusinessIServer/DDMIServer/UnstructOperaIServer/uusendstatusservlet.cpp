...
UpdateUnstructSendStatusServlet::UpdateUnstructSendStatusServlet()
{

}

void UpdateUnstructSendStatusServlet::doExec(DRequestContext *request, DResponseContext *response)
{
    ...
    //处理业务
    try{
        CSUnstructDao::updateRTaskSendStatusByUUID(taskUuid,uuids,state);
    }
