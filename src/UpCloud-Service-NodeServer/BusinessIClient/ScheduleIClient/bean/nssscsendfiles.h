#ifndef NSSSCHEDULESENDFILES_H
#define NSSSCHEDULESENDFILES_H
#include <QtCore>

/**
 * @brief The NsSScheduleSendFiles class    控制传输任务下发文件处理归档表
 * 存放控制传输任务下发文件
 * 状态0代表未下载，1代表下载出错，2代表下载成功，3代表入口文件执行出错，4代表入口文件执行成功
 */
class NsSScheduleSendFiles
{
private:
    //UUID
    QString uuid;
