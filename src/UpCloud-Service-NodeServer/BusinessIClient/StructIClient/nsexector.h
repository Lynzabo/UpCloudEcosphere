#ifndef NODERSTRUCTEXECTOR_H
#define NODERSTRUCTEXECTOR_H
...
class STRUCTICLIENTSHARED_EXPORT NoderStructExector : public AbstractExector
{
    Q_OBJECT
public:
    NoderStructExector();
...
private:
    //服务端对象
    QMap<QTcpSocket *, QString> m_centerSocks;
    //主动推送上下文
