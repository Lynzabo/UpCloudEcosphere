#ifndef NSSUNSTRUCTSENDFILES_H
#define NSSUNSTRUCTSENDFILES_H
#include <QtCore>

/**
 * @brief The NsSUnstructSendFiles class    非结构化任务下发文件处理归档表
 * 存放非结构化任务下发文件
 * 状态0代表未下载，1代表下载出错，2代表下载成功。当出错的时候，ERROR字段填写错误信息，当下载成功或者未下载，ERROR字段为空
 */
class NsSUnstructSendFiles
{
private:
    //UUID
    QString uuid;
