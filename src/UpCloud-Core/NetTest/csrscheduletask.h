#ifndef CSRSCHEDULETASK_H
#define CSRSCHEDULETASK_H

#include <QtCore>

/**
 * @brief The CsRScheduleTask class 控制传输任务表
 * 任务状态代表任务状态，0代表废弃状态，1代表可用，2代表正在下发，3代表已经下发，4代表所有节点服务器下载数据文件时候有出错，
 * 5代表所有节点服务下载都已成功，6代表所有节点服务器解析数据文件有出错，7代表所有节点服务器解析数据文件都成功。执行策略包括
 * 下载策略和数据文件解析策略
 */

class CsRScheduleTask
{
