#ifndef NODERSTRUCTDOWNEXECTOR_H
#define NODERSTRUCTDOWNEXECTOR_H
...
class STRUCTICLIENTSHARED_EXPORT NoderStructDownExector : public AbstractExector
{
    Q_OBJECT
public:
    NoderStructDownExector();
    ~NoderStructDownExector();
protected:
    /**
...
#endif // NODERSTRUCTDOWNEXECTOR_H
